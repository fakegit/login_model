var btoa = require("./index.js");
// npm i btoa  node.js 下载 btoa 包, 将下载好的文件里的 index.js 复制进来, require 引用
...
function encrypt_pwd(password, salt, verify_code) {
    return $pt.Encryption.getEncryption(password, salt, verify_code)
}
