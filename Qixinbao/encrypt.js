...
function s_default(params) {
    var codes = {0: "A", 1: "L", 2: "I", 3: "v", 4: "0", 5: "U", 6: "t", 7: "q", 8: "T", 9: "4", 10: "P", 11: "2", 12: "2", 13: "4", 14: "N", 15: "F", 16: "D", 17: "e", 18: "i", 19: "U"};
...
function header_key() {
    var t = "/api/user/login"
        , e = t.toLowerCase();
    return (0,
        o_HmacSHA1)(e, (0,
        s_default)(e)).toLowerCase().substr(10, 20)
}

function header_value(data) {
    var t = "/api/user/login"
        , n = t.toLowerCase()
