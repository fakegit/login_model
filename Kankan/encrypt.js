...
function encrypt_pwd(q, l, password, z) {
    var r = new RSAKey;
    r.setPublic(b64tohex(q), b64tohex(l));
    return hex2b64(r.encrypt(md5(password) + z))
}

console.log(encrypt_pwd("sa1u+5qkmcrA3r8oecTpeWSoETfptZPy14O3+fM15rCV1ODmhkp4XMq0agYJBBRZlxVMKYqyAqECF0MtyTF2jgrZQpQKLJ4XgxsfLZZO/ITaL7A+9rKElYxvBs8qvyyu+x21YpeD+HCUjX/lf5r1C7mZQ3IJ1RTeXjbjOMnnc9M=", "AQAB", "密码", "!HT5"));
