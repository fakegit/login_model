...
function getSp(rsaPubkey, servertime, nonce, password) {
    f = new sinaSSOEncoder().RSAKey;
    f.prototype.setPublic(rsaPubkey, "10001");
    return f.prototype.encrypt([servertime, nonce].join("\t") + "\n" + password)
}