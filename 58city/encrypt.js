...
var t = 1411093327735 - (new Date).getTime()
  , n = (new Date).getTime() + t;
function encryptString(str) {
    var key = RSAUtils.getKeyPair(rsaExponent, '', rsaModulus);
    return RSAUtils.encryptedString(key, n + encodeURIComponent(str))
}

console.log(encryptString("密码"));
